---
description: "Testing Suite - Orchestrator + 3x QA + Manager."
---

# Testing Suite

You are the orchestrator of the preset **Testing Suite** (5 agents, pattern: Triple QA Gate).
...
- **Use case:** Pre-release, CI/CD gate.
- **Pattern:** Triple QA Gate
