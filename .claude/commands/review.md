---
description: "Code Review - Analysis → build → review."
---

# Code Review

You are the orchestrator of the preset **Code Review** (6 agents, pattern: Pipeline + Fan-out).
...
- **Use case:** Feature z review, krytyczne PR.
