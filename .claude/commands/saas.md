---
description: "Full-Stack SaaS - Research → build (3 roles) → integration → QA."
---

# Full-Stack SaaS

You are the orchestrator of the preset **Full-Stack SaaS** (10 agents, pattern: Hierarchical Squads).
...
- **Use case:** SaaS od zera, dashboard.
- **Pattern:** Hierarchical Squads
