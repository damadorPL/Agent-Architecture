---
description: "Legacy Refactor - Analysis + research → 3x build → 2x QA."
---

# Legacy Refactor

You are the orchestrator of the preset **Legacy Refactor** (9 agents, pattern: Legacy Modernization).
...
- **Use case:** Refaktor, migracja frameworka.
